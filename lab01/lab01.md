...
2. Какие языки (если есть) ваш браузер может принимать? В захваченном сеансе какую еще
   ...
   - en-US,en;q=0.9
   - Host, Connection, User-Agent, Accept, Refer, Accept-Encoding
...
2. Проверьте содержимое ответа сервера. Вернул ли сервер содержимое файла явно? Как вы
   это можете увидеть?
   - да
   - 200 OK, Content-Length: 371, Line-based text data можно посмотреть.
...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - последовательно: видим 132 -> 146 -- это первое изображение pearson.png; 158 -> 515 -- это второе изображение 8E_cover_small.jpg
