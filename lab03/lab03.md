...
#### Решение
1. Ждём ещё 447 бит для полного пакета: $\dfrac{56 * 8 - 1}{128 * 2^{10}} \approx 0.0034$ с
2. Передаём пакет: $\dfrac{56 * 8}{2^20} \approx 0.000427$ с
3. Просуммируем с задержкой распространения: $3.4 + 0.43 + 5 = 8.83$ ms
